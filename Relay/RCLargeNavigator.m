...
- (CGRect)frameForInputField:(BOOL)activ {
	...
	return CGRectMake(0, (activ ? 203 : 421), 320, 40);
}
...
- (CGRect)frameForChatTable {
	...
	return CGRectMake(0, bar.frame.size.height+scrollBar.frame.size.height, 320, 432);
}

- (CGRect)frameForMemberPanel {
	if (_isLandscape)
		return CGRectMake(0, 32, 568, 268);
	return CGRectMake(0, bar.frame.size.height+scrollBar.frame.size.height, 320, 459);
}
